...
public class Family implements HumanCreator{
    ...
    public Human bornchild(Family family) {
        ...
        if (isMale) {
            List<String> manNames = Arrays.asList(
                    "Jon",
                    "Luke",
                    "Frodo",
                    "Gandalf",
            ...
            String childName = manNames.get(random.nextInt(manNames.size()));
            return new Man(childName, childSurname, 2025, averageIq, new String[][]{}, family.getPet());
        } else {
            List<String> womanNames = Arrays.asList(
                    "Arya",
                    "Leia",
                    "Hermione",
                    "Daenerys",
            ...
            String childName = womanNames.get(random.nextInt(womanNames.size()));
            return new Woman(childName, childSurname, 2025, averageIq, new String[][]{}, family.getPet());
        }
    }
}